...
<head>
	...
	<title>Data Ibu Kandung - Siswa Panel</title>
		...
		<div class="row main-header">
			<div class="col s12">
				<div class="card-panel blue-grey darken-3">
					<div class="">
						<span class="white-text">
							<b>
								<span>Lengkap :</span>
								<span class="new badge {{ $this->presentase_color['data_ibu'] }}" data-badge-caption="%">{{ $this->presentase_data->data_ibu }}</span>
							</b>
						</span>
					</div>
					<div class="">
				...
				<div class="card-panel blue-grey darken-3 white-text data-update">
					<span><b>Data ibu</b> terakhir diperbarui pada </span>
						...
						<div class="body">
							<table class="striped">
								<tbody>
									<tr>
										<th>Nama Ibu</th>
										<td>{{ $this->data_ibu->nama }}</td>
									</tr>
									<tr>
										<th>NIK Ibu</th>
										<td>{{ $this->data_ibu->nik }}</td>
									</tr>
									<tr>
										<th>Tahun Lahir</th>
										<td>{{ $this->data_ibu->tahun_lahir }}</td>
									</tr>
									<tr>
										<th>Pendidikan</th>
										<td>{{ $this->data_ibu->pendidikan }}</td>
									</tr>
									<tr>
										<th>Pekerjaan</th>
										<td>{{ $this->data_ibu->pekerjaan }}</td>
									</tr>
									<tr>
										<th>Penghasilan Bulanan</th>
										<td>{{ $this->data_ibu->penghasilan }}</td>
									</tr>
									<tr>
										<th>Berkebutuhan Khusus</th>
										<td>{{ $this->data_ibu->berkebutuhan_khusus }}</td>
									</tr>
								</tbody>
							</table>
						</div>
